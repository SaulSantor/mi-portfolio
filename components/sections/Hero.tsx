  ...
  return (
    ...
    >
      ...
      <ScrollReveal className="mx-auto max-w-3xl text-center">
        ...
        <p className={`mb-3 text-xl font-medium sm:text-2xl ${surface.subheading}`}>
          {t.meta.role}
        </p>

        <p className={`mx-auto mb-10 max-w-xl text-base leading-relaxed sm:text-lg ${surface.muted}`}>
          {t.meta.tagline}
        </p>
