...
export const surface = {
  ...
  cardSolid: "border-zinc-200 bg-zinc-100/60 dark:border-zinc-800 dark:bg-zinc-900/40",
  cardInner: "border-zinc-200/80 bg-white/70 dark:border-zinc-800/80 dark:bg-zinc-900/40",
  headerScrolled:
  ...
  navLink: "text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100",
  btnGhost:
